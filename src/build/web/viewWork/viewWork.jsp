                                        ...
                                        <div class="menu-content">
                                            <ul>
                                                ...
                                                <li><input type="checkbox" name="studentName" value="studentName"
                                                           checked><span>Họ Tên</span></li>
                                                <li><input type="checkbox" name="studentCode" value="studentCode"
                                                           checked><span>Mã Sinh Viên</span></li>
                                                <li><input type="checkbox" name="project" value="project" checked><span>Đề Tài</span></li>
                                                ...
                                                <li><input type="checkbox" name="three" value="three" checked><span>Báo Cáo 3</span></li>
                                                <li><input type="checkbox" name="document" value="document"><span>Link Bản Mềm</span></li>
                                                <li><input type="checkbox" name="sourceCode" value="sourceCode" checked><span>Link Mã Nguồn</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <thead>
                                            <tr>
                                                <th id="group" class="group" rowspan="2">
                                                    <p>Nhóm<i class="fas fa-sort"></i></p>
                                                </th>
